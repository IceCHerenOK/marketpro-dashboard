          ...
          <div className="w-full max-w-md space-y-8">
            <div className="text-center">
              ...
              <p className="mt-2 text-sm" style={{ color: 'var(--text-tertiary)' }}>
                Управляйте продажами и аналитикой по маркетплейсам в одном окне.
              </p>
            </div>
            ...
            <div className="text-center">
              <p className="text-sm" style={{ color: 'var(--text-tertiary)' }}>
                ...
                <span className="font-medium">chubarov.a@azotstore.ru</span> /{' '}
                <span className="font-medium">icekenrok446</span>
              </p>
            </div>
        ...
        >
          <div className="max-w-lg p-8 text-white">
            ...
            <p className="text-lg mb-8 opacity-90">
              MarketPro — это комплексное решение для аналитики и управления продажами на всех
              популярных маркетплейсах России.
            </p>
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm opacity-80">
                    Отслеживайте и управляйте заказами со всех маркетплейсов в одном месте
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm opacity-80">
                    Получайте детальные отчеты о продажах, конверсии и эффективности рекламы
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm opacity-80">
                    Контролируйте доходы, расходы и прибыльность вашего бизнеса
                  </p>
                </div>
              </div>
            </div>
